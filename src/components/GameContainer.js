...
export default function GameContainer({ currentQuestion }) {
	//
	...
	return (
		//
		<div className="container" key={`${questions.id}`}>
			<div className="question-container">
				<h1>{currentQuestion[1].question}</h1>
			</div>
			{/*<div>*/}
			...
			<div className="answer-btns">
				...
				<button className="correct-btn">{currentQuestion[1].answer}</button>
